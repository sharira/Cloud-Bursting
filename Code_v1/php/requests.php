...
function viewRequests() {
	...
	print "<a href='./.ht-inc/listaws.php/?uname=".$user['unityid']."'>Your AWS Reservation </a>";
}
...
//	$tmpunityid = $user['unityid'];
	...
	if($rc < 1) {
		...
		// $user['id'];
		//echo 'hi';
		print "mySuggestedTimes();";
		//print "dijit.byId('suggestedTimes').value = {$tmpunityid};";
		//print "dojo.byId('suggestcont').value = $user[unityid];";
		$cdata = array('now' => 0,
		               'start' => $start, 
		               'end' => $end,
		               'server' => 0,
